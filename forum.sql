...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 05 2024 г., 21:37
...
CREATE TABLE `thread` (
  ...
  `created_at` datetime NOT NULL,
  `closed` tinyint(1) NOT NULL COMMENT 'закрыт тред или нет',
