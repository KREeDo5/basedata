...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 07 2024 г., 21:08
...
INSERT INTO `message` (`id`, `text`, `created_at`, `id_user`, `id_thread`) VALUES
(1, 'Переустанови винду', '2024-10-05 18:36:10', 1, 1),
(2, 'Решено, надо было активировать винду', '2024-10-05 18:36:39', 2, 1),
(3, ' у тебя 8 озу? или 16?\r\nкак вообще ноут сам по себе?', '2024-10-05 18:39:37', 1, 2),
(4, '8, все устраивает, все тянет вроде пока что', '2024-10-05 18:42:43', 2, 2),
(5, 'лучше зарядить до фула и использовать, потом опять заряжать', '2024-10-05 18:42:43', 1, 2),
(6, 'Нет', '2024-10-05 18:44:12', 1, 3),
(7, 'АВТООЧИЩЕНИЕ СТОИТ', '2024-10-05 18:44:12', 1, 3),
(8, 'по умолчанию нет, в настройках можно задать время удаления', '2024-10-05 18:44:47', 1, 3),
(9, 'Я же говорил', '2024-10-07 16:18:03', 1, 1),
(10, 'Linux фигня', '2024-10-07 21:07:24', 4, 4);
